...
The goal of regexciteJohnShiu is to make regular expressions more exciting!
...
You can install the development version of regexciteJohnShiu from [GitHub](https://github.com/) with:
