...
The goal of regexciteJohnShiu is to make regular expressions more
...
You can install the development version of regexciteJohnShiu from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("JohnShiuMK/regexciteJohnShiu")
```
